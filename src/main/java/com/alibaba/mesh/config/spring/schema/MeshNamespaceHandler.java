...
public class MeshNamespaceHandler extends NamespaceHandlerSupport {
    ...
    public void init() {
        ...
        registerBeanDefinitionParser("service", new MeshBeanDefinitionParser(ExportBean.class, true));
        registerBeanDefinitionParser("reference", new MeshBeanDefinitionParser(RefererBean.class, false));
    }
