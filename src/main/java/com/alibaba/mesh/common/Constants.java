...
public class Constants {
    ...
    public static final String AGENT_PROPERTIES_KEY = "mesh.properties.file";

    public static final String DEFAULT_AGENT_PROPERTIES = "mesh.properties";
    ...
    public static final int DEFAULT_IO_THREADS = Math.min(Runtime.getRuntime().availableProcessors(), 32);
...
//    public static final int DEFAULT_REGISTRY_CONNECT_TIMEOUT = 5000;
    ...
    public static final String WRITE_TIMESTAMP = "write.timestamp";
    ...
    @Deprecated
    public static final String SHUTDOWN_WAIT_SECONDS_KEY = "mesh.service.shutdown.wait.seconds";

    public static final String SHUTDOWN_WAIT_KEY = "mesh.service.shutdown.wait";
    ...
    public static final String STUB_EVENT_KEY = "mesh.stub.event";

    public static final boolean DEFAULT_STUB_EVENT = false;

    public static final String STUB_EVENT_METHODS_KEY = "mesh.stub.event.methods";
    ...
    public static final String AGENT_IP_TO_REGISTRY = "AGENT_IP_TO_REGISTRY";

    public static final String AGENT_PORT_TO_REGISTRY = "AGENT_PORT_TO_REGISTRY";
